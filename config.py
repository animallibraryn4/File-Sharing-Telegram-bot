...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002299251309"))
...
TUT_VID = os.environ.get("TUT_VID","https://t.me/animestorys_1/28")
...
ADMIN_LIST = os.environ.get("ADMINS", "6444198928").split()
